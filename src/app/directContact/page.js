...
const DirectContact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_9ag4c8x', 'template_nkpxays', e.target, 'lkpa6Bm85yAOSRD5H')
      .then(
        (result) => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-screen w-screen bg-gradient-to-br from-[white] via-blue-[#1e2760] to-[#040d3e] overflow-hidden">
